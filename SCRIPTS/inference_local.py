...
CONFIG = {
    ...
    "FUSION_FILE": "models/fusion_encoder_paper.py",
    "DECODER_FILE": "models/lidar_decoder_paper.py",
    "LOSSES_FILE":  "losses.py",


    "CHECKPOINT": "/Volumes/One Touch/GEN_AI_PROJECT/phase_2/WEIGHTS/epoch_5.pt",
    ...
    "SAVE_PRED_PLY": True,
    "PRED_PLY_OUT": "/Volumes/One Touch/GEN_AI_PROJECT/phase_2/OUTPUTS/infer_preview/predicted_pointcloud.ply",
}
# ===================================================================
...
MultimodalTransformerEncoder = _load_symbol(CONFIG["FUSION_FILE"],  "MultimodalTransformerEncoder")

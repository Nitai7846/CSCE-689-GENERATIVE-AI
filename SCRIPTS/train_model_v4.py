...
from models.fusion_encoder_paper_v3 import CrossModalTransformerEncoder
...
CONFIG = {
    "embedding_dir": "/scratch/user/haikookhandor/genai/embeddings/s31/unit1",
    "lidar_dir":     "/scratch/user/haikookhandor/genai/datasets/s31/scenario31/unit1/lidar_data_renamed",
    "save_dir":      "/scratch/user/haikookhandor/genai/code_nitai/paper_old2",
    "epochs":        12,
    "lr":            2e-4,
    "batch_size":    8,
    "save_every":    5,
...
def main():
    ...
    fusion = CrossModalTransformerEncoder().to(device)
